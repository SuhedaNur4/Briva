...
def seed():
    ...
    with app.app_context():
        ...
        orgs_data = [
            dict(name='Türk Eğitim Vakfı (TEV)', description="Eğitimde fırsat eşitliği için öğrencilere burs ve eğitim destekleri sunan Türkiye'nin köklü eğitim vakfı. TEV gönüllüsü olarak gençlerin aydınlık geleceğine katkı sağlayabilir, çeşitli projelerde mentor veya destekçi olarak yer alabilirsiniz.", website='https://www.tev.org.tr/', logo_url='https://t2.gstatic.com/faviconV2?client=SOCIAL&type=FAVICON&fallback_opts=TYPE,SIZE,URL&url=http://tev.org.tr&size=128', city='İstanbul', is_verified=True),
            dict(name='Kanserli Çocuklara Umut Vakfı (KAÇUV)', description="Kanserli çocukların tedavilerinin sürekliliğini sağlamak ve ailelerine psikolojik, sosyal destek veren vakıf. Aile evlerinde, hastane oyun odalarında veya organizasyonlarda çocukların yüzünü güldüren etkinliklere katılabilirsiniz.", website='https://kacuv.org/', logo_url='https://t2.gstatic.com/faviconV2?client=SOCIAL&type=FAVICON&fallback_opts=TYPE,SIZE,URL&url=http://kacuv.org&size=128', city='İstanbul', is_verified=True),
            dict(name='TEMA Vakfı', description="Türkiye'nin çöl olmasını engellemek, erozyonla mücadele ve doğa koruma çalışmaları yürüten vakıf. Toprak Dede'nin izinden giderek fidan dikimi etkinliklerine, çevre eğitimlerine ve doğa yürüyüşlerine katılabilirsiniz.", website='https://www.tema.org.tr/', logo_url='https://t2.gstatic.com/faviconV2?client=SOCIAL&type=FAVICON&fallback_opts=TYPE,SIZE,URL&url=http://tema.org.tr&size=128', city='İstanbul', is_verified=True),
            dict(name='LÖSEV', description="Lösemili çocukların sağlık ve eğitim başta olmak üzere her türlü ihtiyaçlarının sağlanması için çalışan vakıf. LSV Dükkan, hastane etkinlikleri veya kampanya süreçlerinde aktif rol alarak lösemili çocuklara umut olabilirsiniz.", website='https://www.losev.org.tr/', logo_url='https://t2.gstatic.com/faviconV2?client=SOCIAL&type=FAVICON&fallback_opts=TYPE,SIZE,URL&url=http://losev.org.tr&size=128', city='Ankara', is_verified=True),
            dict(name='Çağdaş Yaşamı Destekleme Derneği (ÇYDD)', description="Atatürk ilke ve devrimlerini korumak, geliştirmek, çağdaş eğitim yoluyla çağdaş insan ve çağdaş topluma ulaşmak amacını güden dernek. ÇYDD gönüllüsü olarak gençlerin eğitimine ve kişisel gelişimine katkı sağlayan projelerde yer alabilirsiniz.", website='https://www.cydd.org.tr/', logo_url='https://t2.gstatic.com/faviconV2?client=SOCIAL&type=FAVICON&fallback_opts=TYPE,SIZE,URL&url=http://cydd.org.tr&size=128', city='İstanbul', is_verified=True),
            dict(name='Türk Kızılay', description="Afet müdahalesi, kan hizmetleri ve insani yardımlar konusunda ulusal ve uluslararası ölçekte çalışan kurum. Kızılay gönüllüleri, kan bağışı organizasyonlarından afet bölgelerindeki yardım dağıtımlarına kadar geniş bir yelpazede çalışır.", website='https://www.kizilay.org.tr/', logo_url='https://t2.gstatic.com/faviconV2?client=SOCIAL&type=FAVICON&fallback_opts=TYPE,SIZE,URL&url=http://kizilay.org.tr&size=128', city='Ankara', is_verified=True),
            dict(name='AFAD', description="Afet ve acil durumlara müdahale eden resmi kurum. AFAD Gönüllüsü olarak afet öncesi eğitimlere katılabilir ve olası afetlerde arama-kurtarma, ilk yardım ve lojistik destek ekiplerinde görev alabilirsiniz.", website='https://www.afad.gov.tr/', logo_url='https://t2.gstatic.com/faviconV2?client=SOCIAL&type=FAVICON&fallback_opts=TYPE,SIZE,URL&url=http://afad.gov.tr&size=128', city='Ankara', is_verified=True),
            dict(name='AKUT Arama Kurtarma', description="Doğal afetlerde, kazalarda arama kurtarma çalışmaları yapan, alanında öncü gönüllü kuruluş. AKUT gönüllüsü olarak arama kurtarma operasyonlarında, lojistik destekte veya farkındalık eğitimlerinde görev alabilirsiniz.", website='https://www.akut.org.tr/', logo_url='https://t2.gstatic.com/faviconV2?client=SOCIAL&type=FAVICON&fallback_opts=TYPE,SIZE,URL&url=http://akut.org.tr&size=128', city='İstanbul', is_verified=True),
            dict(name='Darüşşafaka Cemiyeti', description="Babası veya annesi hayatta olmayan, maddi olanakları yetersiz yetenekli çocuklara nitelikli eğitim veren cemiyet. Darüşşafaka'nın eğitim misyonuna destek olmak için organizasyonlarda ve bağış kampanyalarında gönüllü olabilirsiniz.", website='https://www.darussafaka.org/', logo_url='https://t2.gstatic.com/faviconV2?client=SOCIAL&type=FAVICON&fallback_opts=TYPE,SIZE,URL&url=http://darussafaka.org&size=128', city='İstanbul', is_verified=True),
            dict(name='Toplum Gönüllüleri Vakfı (TOG)', description="Gençlerin öncülüğünde sivil toplum projeleri yaratarak gençlerin kişisel gelişimlerini destekleyen vakıf. Üniversite kulüplerinde örgütlenerek yerel sorunlara çözüm üreten projeler tasarlayabilir ve uygulayabilirsiniz.", website='https://www.tog.org.tr/', logo_url='https://t2.gstatic.com/faviconV2?client=SOCIAL&type=FAVICON&fallback_opts=TYPE,SIZE,URL&url=http://tog.org.tr&size=128', city='İstanbul', is_verified=True),
            dict(name='Kadın Emeğini Değerlendirme Vakfı (KEDV)', description="Dar gelirli kadınların ekonomik ve sosyal olarak güçlenmelerini, yerel kalkınmaya liderlik etmelerini destekleyen vakıf. Kadın kooperatifleri ve erken çocukluk eğitimi projelerinde uzmanlığınızla katkı sunabilirsiniz.", website='https://www.kedv.org.tr/', logo_url='https://t2.gstatic.com/faviconV2?client=SOCIAL&type=FAVICON&fallback_opts=TYPE,SIZE,URL&url=http://kedv.org.tr&size=128', city='İstanbul', is_verified=True),
            dict(name='Türkiye Korunmaya Muhtaç Çocuklar Vakfı (KORUNCUK)', description="Çocukların sevgi ve şefkatle büyüdüğü, eğitimlerinden mahrum kalmadığı bir yaşam kurmak için çalışan vakıf. Koruncukköy'lerde veya idari ofislerde, çocukların sosyal ve kültürel gelişimlerine destek olabilirsiniz.", website='https://koruncuk.org/', logo_url='https://t2.gstatic.com/faviconV2?client=SOCIAL&type=FAVICON&fallback_opts=TYPE,SIZE,URL&url=http://koruncuk.org&size=128', city='İstanbul', is_verified=True),
            dict(name='AÇEV', description="Erken çocukluk, anne-baba ve kadın destek eğitimleriyle toplumsal gelişime katkı sağlayan vakıf. Saha araştırmalarında, ofis çalışmalarında veya eğitim materyallerinin hazırlanmasında AÇEV ekibine gönüllü destek verebilirsiniz.", website='https://www.acev.org/', logo_url='https://t2.gstatic.com/faviconV2?client=SOCIAL&type=FAVICON&fallback_opts=TYPE,SIZE,URL&url=http://acev.org&size=128', city='İstanbul', is_verified=True),
            dict(name='Türkiye Sakatlar Derneği', description="Engelli bireylerin haklarını savunan, onların sosyal ve ekonomik hayata entegrasyonu için çalışan dernek. Erişilebilirlik projeleri, tekerlekli sandalye dağıtımı ve sosyal etkinliklerde derneğin çalışmalarına destek olabilirsiniz.", website='https://www.tsd.org.tr/', logo_url='https://t2.gstatic.com/faviconV2?client=SOCIAL&type=FAVICON&fallback_opts=TYPE,SIZE,URL&url=http://tsd.org.tr&size=128', city='İstanbul', is_verified=True),
            dict(name='Yeşilay', description="Toplumu başta sigara, alkol, uyuşturucu olmak üzere her türlü bağımlılıktan korumak için çalışan kurum. Sağlıklı yaşam bilincini artırmaya yönelik seminerler, gençlik kampları ve spor etkinliklerinde gönüllü elçi olabilirsiniz.", website='https://www.yesilay.org.tr/', logo_url='https://t2.gstatic.com/faviconV2?client=SOCIAL&type=FAVICON&fallback_opts=TYPE,SIZE,URL&url=http://yesilay.org.tr&size=128', city='İstanbul', is_verified=True),
            dict(name='Türk Kanser Derneği', description="Kanser hastalıklarıyla ilgili farkındalık yaratma, erken teşhis ve tedavi süreçlerinde hastalara destek olan dernek. Bilinçlendirme kampanyalarında, hasta ziyaretlerinde veya organizasyonel süreçlerde yer alabilirsiniz.", website='https://www.turkkanserdernegi.org/', logo_url='https://t2.gstatic.com/faviconV2?client=SOCIAL&type=FAVICON&fallback_opts=TYPE,SIZE,URL&url=http://turkkanserdernegi.org&size=128', city='İstanbul', is_verified=True),
            dict(name='Mor Çatı Kadın Sığınağı Vakfı', description="Erkek şiddetine maruz kalan kadınlara psikolojik, hukuki destek veren ve sığınak çalışması yürüten vakıf. Dayanışma merkezlerinde, organizasyonlarda veya uzmanlık alanınıza (hukuk, psikoloji) göre gönüllü destek sağlayabilirsiniz.", website='https://morcati.org.tr/', logo_url='https://t2.gstatic.com/faviconV2?client=SOCIAL&type=FAVICON&fallback_opts=TYPE,SIZE,URL&url=http://morcati.org.tr&size=128', city='İstanbul', is_verified=True),
            dict(name='DenizTemiz Derneği (TURMEPA)', description="Türkiye'nin denizlerinin ve su yollarının temizliğini sağlamak, korumak ve gelecek nesillere aktarmak için çalışan dernek. Kıyı temizlik etkinliklerine, sualtı atık çıkarma organizasyonlarına ve eğitim projelerine katılabilirsiniz.", website='https://www.turmepa.org.tr/', logo_url='https://t2.gstatic.com/faviconV2?client=SOCIAL&type=FAVICON&fallback_opts=TYPE,SIZE,URL&url=http://turmepa.org.tr&size=128', city='İstanbul', is_verified=True),
            dict(name='Türkiye Tabiatını Koruma Derneği (TTKD)', description="Türkiye'nin doğal zenginliklerini, flora ve faunasını korumak için bilimsel ve eğitimsel çalışmalar yapan dernek. Doğa kamplarında, ekolojik araştırmalarda ve çevre bilinci yaratma projelerinde aktif rol alabilirsiniz.", website='https://www.ttkd.org.tr/', logo_url='https://t2.gstatic.com/faviconV2?client=SOCIAL&type=FAVICON&fallback_opts=TYPE,SIZE,URL&url=http://ttkd.org.tr&size=128', city='Ankara', is_verified=True),
            dict(name='Hayvan Hakları Federasyonu (HAYTAP)', description="Hayvan haklarının yasalarla güvence altına alınması ve toplumda farkındalık yaratılması için çalışan federasyon. Barınak iyileştirme, mama dağıtımı ve hukuki hak arama süreçlerinde HAYTAP'a destek olabilirsiniz.", website='https://www.haytap.org/', logo_url='https://t2.gstatic.com/faviconV2?client=SOCIAL&type=FAVICON&fallback_opts=TYPE,SIZE,URL&url=http://haytap.org&size=128', city='İstanbul', is_verified=True),
        ]
        ...
        events_data.append(dict(
            ...
            title='Geçmiş Çevre Temizliği Etkinliği',
            description='Geçmişte yapılmış ve tamamlanmış örnek bir etkinlik. Ali Yılmaz bu etkinliğe katılıp iyilik puanı kazandı.',
            category='çevre',
            city='İstanbul',
            address='Kadıköy Sahil',
            start_date=now - timedelta(days=10, hours=4),
            end_date=now - timedelta(days=10, hours=0),
            max_volunteers=20,
            status='completed'
        ))
        ...
        app_past = EventApplication(user_id=volunteer1.id, event_id=events[-1].id, status='approved', cover_letter='Eski bir etkinlik başvurusu.', reviewer_note='Katılım sağladı.')
        db.session.add(app_past)
        db.session.commit()
        
        award_xp(app_past.user_id, 'EVENT_COMPLETED', 'event', app_past.event_id)
        db.session.commit()
