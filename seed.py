...
def seed():
    ...
    with app.app_context():
        ...
        orgs_data = [
    dict(name='Türk Eğitim Vakfı (TEV)', description='Eğitimde fırsat eşitliği için öğrencilere burs ve eğitim destekleri sunan Türkiye\'nin köklü eğitim vakfı.', website='tev.org.tr', logo_url='https://logo.clearbit.com/tev.org.tr', phone='', address='', city='', is_verified=True),
    dict(name='AKUT Arama Kurtarma Derneği', description='Doğal afetlerde, kazalarda arama kurtarma çalışmaları yapan, alanında öncü gönüllü kuruluş.', website='akut.org.tr', logo_url='https://logo.clearbit.com/akut.org.tr', phone='', address='', city='', is_verified=True),
    dict(name='TEMA Vakfı', description='Türkiye\'nin çöl olmasını engellemek, erozyonla mücadele ve doğa koruma çalışmaları yürüten vakıf.', website='tema.org.tr', logo_url='https://logo.clearbit.com/tema.org.tr', phone='', address='', city='', is_verified=True),
    dict(name='Darüşşafaka Cemiyeti', description='Babası veya annesi hayatta olmayan, maddi olanakları yetersiz yetenekli çocuklara nitelikli eğitim veren cemiyet.', website='darussafaka.org', logo_url='https://logo.clearbit.com/darussafaka.org', phone='', address='', city='', is_verified=True),
    dict(name='Türk Kızılay', description='Afet müdahalesi, kan hizmetleri ve insani yardımlar konusunda ulusal ve uluslararası ölçekte çalışan kurum.', website='kizilay.org.tr', logo_url='https://logo.clearbit.com/kizilay.org.tr', phone='', address='', city='', is_verified=True),
    dict(name='LÖSEV', description='Lösemili çocukların sağlık ve eğitim başta olmak üzere her türlü ihtiyaçlarının sağlanması için çalışan vakıf.', website='losev.org.tr', logo_url='https://logo.clearbit.com/losev.org.tr', phone='', address='', city='', is_verified=True),
    dict(name='Hayvan Hakları Federasyonu (HAYTAP)', description='Hayvan haklarının yasalarla güvence altına alınması ve toplumda farkındalık yaratılması için çalışan federasyon.', website='haytap.org', logo_url='https://logo.clearbit.com/haytap.org', phone='', address='', city='', is_verified=True),
    dict(name='Türkiye Spastik Çocuklar Vakfı', description='Cerebral Palsy\'li çocuk ve erişkinlere teşhis, tedavi ve özel eğitim hizmeti veren vakıf.', website='tscv.org.tr', logo_url='https://logo.clearbit.com/tscv.org.tr', phone='', address='', city='', is_verified=True),
    dict(name='KAÇUV', description='Kanserli çocukların tedavilerinin sürekliliğini sağlamak ve ailelerine psikolojik, sosyal destek veren vakıf.', website='kacuv.org', logo_url='https://logo.clearbit.com/kacuv.org', phone='', address='', city='', is_verified=True),
    dict(name='Türkiye Down Sendromu Derneği', description='Down sendromlu bireylerin toplumda bağımsız ve eşit yaşam sürmeleri için projeler üreten dernek.', website='dsd.org.tr', logo_url='https://logo.clearbit.com/dsd.org.tr', phone='', address='', city='', is_verified=True),
    dict(name='Toplum Gönüllüleri Vakfı (TOG)', description='Gençlerin öncülüğünde sivil toplum projeleri yaratarak gençlerin kişisel gelişimlerini destekleyen vakıf.', website='tog.org.tr', logo_url='https://logo.clearbit.com/tog.org.tr', phone='', address='', city='', is_verified=True),
    dict(name='Kadın Emeğini Değerlendirme Vakfı (KEDV)', description='Dar gelirli kadınların ekonomik ve sosyal olarak güçlenmelerini, yerel kalkınmaya liderlik etmelerini destekleyen vakıf.', website='kedv.org.tr', logo_url='https://logo.clearbit.com/kedv.org.tr', phone='', address='', city='', is_verified=True),
    dict(name='Türkiye Korunmaya Muhtaç Çocuklar Vakfı (KORUNCUK)', description='Çocukların sevgi ve şefkatle büyüdüğü, eğitimlerinden mahrum kalmadığı bir yaşam kurmak için çalışan vakıf.', website='koruncuk.org', logo_url='https://logo.clearbit.com/koruncuk.org', phone='', address='', city='', is_verified=True),
    dict(name='AÇEV', description='Erken çocukluk, anne-baba ve kadın destek eğitimleriyle toplumsal gelişime katkı sağlayan vakıf.', website='acev.org', logo_url='https://logo.clearbit.com/acev.org', phone='', address='', city='', is_verified=True),
    dict(name='Türkiye Sakatlar Derneği', description='Engelli bireylerin haklarını savunan, onların sosyal ve ekonomik hayata entegrasyonu için çalışan dernek.', website='tsd.org.tr', logo_url='https://logo.clearbit.com/tsd.org.tr', phone='', address='', city='', is_verified=True),
    dict(name='Yeşilay', description='Toplumu başta sigara, alkol, uyuşturucu olmak üzere her türlü bağımlılıktan korumak için çalışan kurum.', website='yesilay.org.tr', logo_url='https://logo.clearbit.com/yesilay.org.tr', phone='', address='', city='', is_verified=True),
    dict(name='Türk Kanser Derneği', description='Kanser hastalıklarıyla ilgili farkındalık yaratma, erken teşhis ve tedavi süreçlerinde hastalara destek olan dernek.', website='turkkanserdernegi.org', logo_url='https://logo.clearbit.com/turkkanserdernegi.org', phone='', address='', city='', is_verified=True),
    dict(name='Mor Çatı Kadın Sığınağı Vakfı', description='Erkek şiddetine maruz kalan kadınlara psikolojik, hukuki destek veren ve sığınak çalışması yürüten vakıf.', website='morcati.org.tr', logo_url='https://logo.clearbit.com/morcati.org.tr', phone='', address='', city='', is_verified=True),
    dict(name='DenizTemiz Derneği (TURMEPA)', description='Türkiye\'nin denizlerinin ve su yollarının temizliğini sağlamak, korumak ve gelecek nesillere aktarmak için çalışan dernek.', website='turmepa.org.tr', logo_url='https://logo.clearbit.com/turmepa.org.tr', phone='', address='', city='', is_verified=True),
    dict(name='Türkiye Tabiatını Koruma Derneği (TTKD)', description='Türkiye\'nin doğal zenginliklerini, flora ve faunasını korumak için bilimsel ve eğitimsel çalışmalar yapan dernek.', website='ttkd.org.tr', logo_url='https://logo.clearbit.com/ttkd.org.tr', phone='', address='', city='', is_verified=True),
]
